  ...
  return (
    <div className="footer">
      ...
      <ul className="footer__info footer__info_left">
        <li><a href=""><b>Условия использования</b></a></li>
        <li><a href=""><b>О проекте </b></a></li>
      </ul>
      <div className="footer__info footer__info_right">
        <a href=""><b>Вопросы и сотрудничество</b></a>
        <a href="https://vk.com/al_feed.php "><p>Вконтакте</p></a>
